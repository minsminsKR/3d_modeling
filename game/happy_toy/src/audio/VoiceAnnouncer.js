...
const VOICE_LINES = {
  ...
  nurseryhall: "보육 복도입니다. 요람이 동쪽 벽에 붙어 있습니다.",
  ...
  classwing: "교실 날개입니다. 책상 사이로 숨으십시오.",
  uncathall: "교차로입니다. 칠판의 출석을 읽지 마십시오.",
  northhall: "북쪽 복도입니다. 알코브 신발장으로.",
  b1boiler: "보일러실입니다. 물이 이름을 적고 있습니다.",
  f2bloodhall: "피 묻은 복도입니다. 액자를 보지 마십시오.",
  annexgate: "별관 입구입니다. 실내화를 갈아 신지 마십시오.",
  b1floodclass: "침수 교실입니다. 책상 밑으로 숨지 마십시오.",
  f2gallery: "졸업 액자입니다. 빈 얼굴을 세지 마십시오.",
