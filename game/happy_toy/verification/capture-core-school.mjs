...
const shots = [
  {
    ...
    x: 18.15, y: 0, z: -13.55,
    lookAt: [21.2, 0.95, -10.8],
  },
  {
    file: "f1_supply_room.png",
    chunks: [[0, -2], [0, -1]],
    status: "비품실입니다. 철창 안에 어제 출석이 잠겨 있습니다.",
    x: 2.15, y: 0, z: -34.35,
    lookAt: [5.35, 1.05, -37.35],
  },
  {
    file: "f1_counsel_room.png",
    chunks: [[-1, -2], [-1, -1]],
  ...
  {
    file: "f1_stair_hall.png",
    chunks: [[1, 1], [0, 1]],
    status: "지하로 가는 복도입니다. 콘 너머로 물이 마릅니다.",
    x: 16.0, y: 0, z: 14.25,
    lookAt: [10.75, 0.55, 12.2],
  },
  {
    file: "f1_nursery_hall.png",
    chunks: [[2, 1], [1, 1]],
    status: "보육 복도입니다. 요람이 서쪽 벽에 붙어 있습니다.",
    x: 30.15, y: 0, z: 16.0,
    lookAt: [28.15, 0.7, 12.85],
  },
  {
    file: "f1_doll_hall.png",
    chunks: [[-2, 1], [-1, 1]],
    status: "인형 복도입니다. 선반의 눈을 마주치지 마십시오.",
    x: -33.15, y: 0, z: 16.0,
    lookAt: [-35.75, 0.95, 12.55],
  },
];
