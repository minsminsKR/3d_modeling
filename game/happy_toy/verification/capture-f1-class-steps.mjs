...
const shots = [
  {
    name: "f1_laundry_west_class_step.png",
    cx: 4, cz: -1, x: 63.55, y: 0, z: -16.05, lookAt: [62.72, 1.15, -13.48],
  },
  {
    name: "f1_tea_north_class_step.png",
    cx: -1, cz: 1, x: -16.05, y: 0, z: 15.55, lookAt: [-14.88, 1.12, 14.52],
  },
  {
    name: "f1_lab_south_class_step.png",
    cx: 5, cz: -2, x: 80.12, y: 0, z: -31.52, lookAt: [82.58, 1.12, -30.68],
  },
];
