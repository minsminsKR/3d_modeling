...
await poseShot("b1_flood_class_desks.png", {
  x: 8.4, y: -5, z: 48.0, lookAt: [5.15, -3.55, 48.2],
});
await poseShot("b1_flood_class_board.png", {
  x: 8.4, y: -5, z: 48.2, lookAt: [4.25, -3.5, 48.2],
});
await poseShot("f2_gallery_frames_row.png", {
  x: -32.5, y: 5, z: -42.4, lookAt: [-28.4, 6.35, -45.2],
});
await poseShot("f2_gallery_north_wall.png", {
  x: -32.5, y: 5, z: -45.0, lookAt: [-36.4, 6.35, -45.2],
});
