...
if (!hide.hidden || !hide.slats || !hide.interior) {
  throw new Error(`locker slats failed: ${JSON.stringify(hide)}`);
}
await page.screenshot({ path: path.join(outDir, "f1_locker_slats_hide.png"), timeout: 120000 });

await browser.close();
console.log("FOYER NOOK HIDE CAPTURES WRITTEN");
