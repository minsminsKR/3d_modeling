...
- 계단은 복도 바닥에서 이어지는 짧은 랜딩, 보행용 램프, 시각용 계단 블록, 양쪽 벽, 벽부착 손잡이, 상부 계단참 벽을 함께 써서 1층에서 2층까지 자연스럽게 이어집니다.
